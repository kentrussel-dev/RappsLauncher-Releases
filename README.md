<div align="center">
  ...
  <p>
    <a href="https://github.com/kentrussel-dev/RappsLauncher-Releases/releases"><img src="https://img.shields.io/badge/Release-v1.4.0-blue?style=flat-square&logo=github" alt="Latest Release" /></a>
...
|---|---|---|---|
| **Windows Setup Wizard (Recommended)** | `.exe` | Windows x64 | **[Download RappsLauncher-Setup-v1.4.0.exe](releases/RappsLauncher-Setup-v1.4.0.exe)** |
| **Portable Zip Package** | `.zip` | Windows x64 | **[Download RappsLauncher-v1.4.0-Portable-win-x64.zip](releases/RappsLauncher-v1.4.0-Portable-win-x64.zip)** |
...
- **Workspace Container Hub (Single-Window Experience)**: Organize your entire workspace inside one unified window with a modern Fluent tab strip.
- **Embedded Web Tabs (Microsoft WebView2)**: Web links and dashboards open directly inside Rapps Launcher with full browser navigation (Back, Forward, Reload, Address bar), keeping your personal browser clean and clutter-free.
- **Application Focus Tabs**: Running desktop apps are listed right in the workspace hub tab strip; click any app tab to instantly bring its window to the front.
- **Dual-Track Workflow (Classic vs. Container)**: Switch back and forth between Classic mode and Container Hub mode anytime via the header button, context menu, or Settings preference.
- **Includes all v1.3.0 capabilities**: One-click workspace teardown with "Close Apps", per-item stop buttons, multi-tier launcher shim detection, and high-contrast badges.
...
1. Download **`RappsLauncher-Setup-v1.4.0.exe`** above.
...
1. Download **`RappsLauncher-v1.4.0-Portable-win-x64.zip`** above.
